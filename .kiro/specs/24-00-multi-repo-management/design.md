...
*For any* project directory structure, scanning must discover all Git repositories (excluding .kiro), correctly extracting their remote URLs and current branches.
