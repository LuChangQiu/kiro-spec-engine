...
**步骤**: 读 `.kiro/README.md` 的「kse Capabilities」章节了解全部能力 → 检查 Steering 是否需更新 → 更新 CURRENT_CONTEXT → 验证一致性

**重要性**: `.kiro/README.md` 是 agent 了解 kse 能力的唯一权威入口。新版本引入新功能、命令、协调机制，agent 必须完整了解才能正确使用（如多 Agent 协调、场景运行时、自主控制等）
