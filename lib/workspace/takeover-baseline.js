...
async function _reconcileCorePrinciplesBaseline(projectPath, options = {}) {
  ...
  const hasClarificationFirstRule = existingContent.includes(CLARIFICATION_FIRST_CORE_PRINCIPLE_HEADING);
  const changed = !hasClarificationFirstRule;
  ...
  return {
    ...
    details: {
      clarification_first_rule_present_before: hasClarificationFirstRule,
      clarification_first_rule_heading: CLARIFICATION_FIRST_CORE_PRINCIPLE_HEADING
    }
  };
}
