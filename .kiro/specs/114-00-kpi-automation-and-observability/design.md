...
- 输入：当周执行数据、历史快照、指标定义
- 输出：周度快照 JSON
- 默认落盘路径：`.kiro/specs/114-00-kpi-automation-and-observability/custom/weekly-metrics/`
...
```json
{
  ...
  "decision": "go",
  "evidence": [
    ".kiro/specs/114-00-kpi-automation-and-observability/custom/weekly-metrics/2026-W08.json"
  ]
}
```
