...
- **Workspace**: A registered kse project directory with its own `.sce/` structure
...
4. WHEN the specified path does not contain a `.sce/` directory, THE CLI SHALL return an error indicating the path is not a valid kse project
