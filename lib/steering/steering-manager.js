  ...
  async promptStrategy(detection) {
    ...
    const response = await prompt({
      ...
      choices: [
        {
          name: 'use-kse',
          message: 'Use kse steering (backup existing files)',
          hint: 'Recommended for new kse users'
        },
        {
          name: 'use-project',
          message: 'Keep existing steering (skip kse steering)',
          hint: 'For projects with custom steering rules'
        }
      ]
    });
