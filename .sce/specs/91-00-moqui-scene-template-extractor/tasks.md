...
- [x] 1. Create moqui-extractor.js with YAML serializer and core utilities
  ...
  - [ ]* 1.2 Write property test for YAML round-trip
  ...
  - [ ]* 1.4 Write property test for entity grouping
...
- [x] 2. Implement pattern matching and analysis
  ...
  - [ ]* 2.3 Write property test for pattern classification
  ...
  - [ ]* 2.4 Write property test for pattern filter
...
- [x] 3. Implement manifest and contract generation
  ...
  - [ ]* 3.3 Write property test for manifest generation
  ...
  - [ ]* 3.4 Write property test for contract generation
  ...
  - [ ]* 3.5 Write property test for JSON round-trip
...
- [x] 5. Implement file writing and extraction pipeline
  ...
  - [ ]* 5.4 Write property test for file writing structure
...
- [x] 6. Implement CLI command integration
  ...
  - [ ]* 6.3 Write property test for option validation
  ...
  - [ ]* 6.4 Write unit tests for CLI command
