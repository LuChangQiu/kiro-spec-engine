...
│  - Create backup │      │  (.kiro/environments.json)│
...
**File Location**: `.kiro/environments.json` (project-level) or `.kiro/workspaces/{workspace-name}/environments.json` (workspace-level)
