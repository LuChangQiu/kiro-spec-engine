...
2. **MCP 澄清**：Model Context Protocol 的角色定位
3. **2000+ 小时实践**：从被动投喂到主动探寻的演化
4. **哲学基础**：逻辑、语言、心学与项目演化
5. **Session 限制**：周期属性与切分策略
6. **kiro-spec-engine**：理念的产品化实践
7. **Steering 规则**：区域化设计与时效性管理

## 🌏 关于中国哲学 / About Chinese Philosophy

For international readers, the English version includes a glossary explaining key philosophical terms:
- **知行合一** (*zhī xíng hé yī*): Unity of knowledge and action
- **心外無物** (*xīn wài wú wù*): Nothing exists outside the mind
- **緣起緣滅** (*yuán qǐ yuán miè*): Dependent origination and cessation

## 🤔 讨论话题

欢迎大家讨论：

1. 你如何看待 AI 在软件开发中的角色转变？
2. 你在使用 AI 编程时遇到过哪些挑战？
3. 你认为"原则驱动 Agent"的理念如何应用到实际项目中？
4. 对于 session 上下文限制，你有什么好的解决方案？
...
*If this article inspires you, welcome to ⭐ Star the project!*
```
