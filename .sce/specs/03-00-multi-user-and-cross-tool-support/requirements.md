...
3. WHEN "use-kse" is selected, THE System SHALL backup existing steering files to `.sce/backups/steering-{timestamp}/` and install kse steering files
4. WHEN "use-project" is selected, THE System SHALL skip kse steering file installation and document this choice in `.sce/adoption-config.json`
...
1. WHEN a developer runs `kse workspace init`, THE System SHALL create a personal workspace directory `.sce/workspace/{username}/`
