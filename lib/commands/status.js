...
async function statusCommand(options = {}) {
  ...
  console.log(chalk.red('🔥') + ' SCO Project Status');
  console.log();
  ...
  try {
    ...
    if (!kiroExists) {
      ...
      console.log('Run ' + chalk.cyan('sco adopt') + ' to get started.');
      return;
    }
    ...
    if (!specsExist) {
      ...
      console.log();
      console.log('Create your first spec: ' + chalk.cyan('sco create-spec my-feature'));
      return;
    }
    ...
    console.log('  View team activity: ' + chalk.cyan('sco status --team'));
    console.log('  Detailed view: ' + chalk.cyan('sco status --verbose'));
    console.log('  Lock a spec: ' + chalk.cyan('sco lock acquire <spec-name>'));
    console.log('  View locks: ' + chalk.cyan('sco lock status'));
    
    if (isMultiUser) {
      console.log('  Claim a task: ' + chalk.cyan('sco task claim <spec-name> <task-id>'));
      console.log('  Sync workspace: ' + chalk.cyan('sco workspace sync'));
    }
...
async function displayDocumentCompliance(projectPath) {
  try {
    ...
    if (report.compliant) {
      ...
      console.log(`    ${chalk.gray('•')} Run diagnostics: ${chalk.cyan('sco doctor --docs')}`);
      console.log(`    ${chalk.gray('•')} Clean temporary files: ${chalk.cyan('sco cleanup')}`);
      console.log(`    ${chalk.gray('•')} Validate structure: ${chalk.cyan('sco validate --all')}`);
      console.log(`    ${chalk.gray('•')} Archive artifacts: ${chalk.cyan('sco docs archive --spec <name>')}`);
    }
