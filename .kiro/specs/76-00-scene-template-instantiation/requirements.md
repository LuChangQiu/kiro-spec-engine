...
- **Instantiation_Log**: A JSON file (`instantiation-log.json`) stored under `.kiro/specs/{spec-name}/` that accumulates a history of all instantiations performed for a given spec
