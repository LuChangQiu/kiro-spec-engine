...
class StatusMonitor {
  ...
  constructor(specLifecycleManager, contextSyncManager) {
     ...
     * @type {{signalCount: number, retryCount: number, totalBackoffMs: number, lastSignalAt: string|null, lastSpecName: string|null, lastRetryCount: number, lastDelayMs: number, lastLaunchHoldMs: number, lastError: string|null}}
     */
    this._rateLimit = {
      signalCount: 0,
      retryCount: 0,
