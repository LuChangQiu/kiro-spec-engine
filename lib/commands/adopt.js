  ...
  try {
    ...
    if (detection.conflicts.length > 0) {
      ...
      if (force) {
        ...
        console.log(chalk.gray('  Existing files will be preserved, template files will be skipped'));
        console.log(chalk.gray('  Use --force to overwrite conflicting files (backup will be created)'));
      }
    }
