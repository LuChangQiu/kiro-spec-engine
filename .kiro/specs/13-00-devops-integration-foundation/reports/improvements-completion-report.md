...
**触发**: 用户发现 `.kiro/specs/SPEC_WORKFLOW_GUIDE.md` 中存在错误的项目引用（"上海图书馆 MinIO"）
...
- [x] 修复 `.kiro/specs/SPEC_WORKFLOW_GUIDE.md`
- [x] 修复 `template/.kiro/specs/SPEC_WORKFLOW_GUIDE.md`
- [x] 修复 `.kiro/steering/ENVIRONMENT.md`
...
- [x] 改进 `template/.kiro/steering/ENVIRONMENT.md` 占位符
- [x] 改进 `template/.kiro/steering/CURRENT_CONTEXT.md` 占位符
- [x] 添加醒目的模板提示
...
- `.kiro/steering/CORE_PRINCIPLES.md` - 更新（添加原则 9）
...
### 修复的文件
9. ✅ `.kiro/specs/SPEC_WORKFLOW_GUIDE.md`
10. ✅ `template/.kiro/specs/SPEC_WORKFLOW_GUIDE.md`
11. ✅ `.kiro/steering/ENVIRONMENT.md`
12. ✅ `template/README.md`
13. ✅ `template/.kiro/steering/ENVIRONMENT.md`
14. ✅ `template/.kiro/steering/CURRENT_CONTEXT.md`

### 更新的文件
15. ✅ `.kiro/steering/CORE_PRINCIPLES.md`
