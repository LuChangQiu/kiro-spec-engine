...
const { getCloseLoopBatchSummaryDir: getCloseLoopBatchSummaryDirService, readCloseLoopBatchSummaryEntries: readCloseLoopBatchSummaryEntriesService, loadCloseLoopBatchSummaryPayload: loadCloseLoopBatchSummaryPayloadService } = require('../auto/batch-summary-storage-service');
...
function resolveControllerQueueFile(projectPath, queueFileCandidate) {
  return resolveControllerQueueFileService(path, projectPath, queueFileCandidate);
}
