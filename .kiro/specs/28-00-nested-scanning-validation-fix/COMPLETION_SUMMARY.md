...
1. **Hidden Directory Names**: Repository names starting with dots (`.github`, `.kiro`) rejected as invalid
...
- ✅ Hidden directories (`.github`, `.kiro`) accepted
...
6. `.kiro/specs/28-00-nested-scanning-validation-fix/requirements.md` - Implementation summary
...
### User Benefits
- Can now manage repositories in hidden directories (`.github`, `.kiro`)
