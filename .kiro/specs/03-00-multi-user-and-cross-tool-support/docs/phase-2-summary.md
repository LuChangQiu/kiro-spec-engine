...
- [x] 6.4: Save to `.kiro/specs/{spec-name}/context-export.md`
...
- [x] 7.4: Save to `.kiro/specs/{spec-name}/prompts/task-{id}.md`
...
cat .kiro/specs/03-00-multi-user-and-cross-tool-support/context-export.md
```
...
cat .kiro/specs/03-00-multi-user-and-cross-tool-support/prompts/task-9-1.md
```
