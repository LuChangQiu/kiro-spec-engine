...
2. Spec Task Sync
   ...
   - Append to `.kiro/specs/<spec>/tasks.md` with dedupe.

## Command Surface Extension

```bash
kse scene package-gate   --registry .kiro/reports/scene-package-registry.json   --policy .kiro/templates/scene-package-gate-policy.json   --spec 71-00-scene-package-gate-task-draft-and-sync   --task-out .kiro/reports/scene-package-gate-task-draft.md   --sync-spec-tasks   --json
```
