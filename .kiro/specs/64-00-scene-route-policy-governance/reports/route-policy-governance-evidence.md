...
- `kse scene route-policy-template --profile hybrid --out .kiro/specs/64-00-scene-route-policy-governance/reports/route-policy-hybrid.json --json`
- `kse scene route --query hybrid --mode commit --route-policy .kiro/specs/64-00-scene-route-policy-governance/reports/route-policy-hybrid.json --json --out .kiro/specs/64-00-scene-route-policy-governance/reports/route-with-policy-sample.json`
