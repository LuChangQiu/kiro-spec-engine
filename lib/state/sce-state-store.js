...
class SceStateStore {
  ...
  async listPmRequirements(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapPmRequirementRow(row));
  }
  ...
  async getPmRequirement(requirementId) {
    ...
    if (!await this.ensureReady()) return null;
    return this._mapPmRequirementRow(this._db.prepare('SELECT * FROM pm_requirement_registry WHERE requirement_id = ?').get(normalizedId));
  }
  ...
  async listPmTracking(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapPmTrackingRow(row));
  }
  ...
  async getPmTracking(trackingId) {
    ...
    if (!await this.ensureReady()) return null;
    return this._mapPmTrackingRow(this._db.prepare('SELECT * FROM pm_tracking_registry WHERE tracking_id = ?').get(normalizedId));
  }
  ...
  async listPmPlans(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapPmPlanRow(row));
  }
  ...
  async getPmPlan(planId) {
    ...
    if (!await this.ensureReady()) return null;
    return this._mapPmPlanRow(this._db.prepare('SELECT * FROM pm_plan_registry WHERE plan_id = ?').get(normalizedId));
  }
  ...
  async listPmChanges(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapPmChangeRow(row));
  }
  ...
  async getPmChange(changeId) {
    ...
    if (!await this.ensureReady()) return null;
    return this._mapPmChangeRow(this._db.prepare('SELECT * FROM pm_change_request_registry WHERE change_id = ?').get(normalizedId));
  }
  ...
  async listPmIssues(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapPmIssueRow(row));
  }
  ...
  async getPmIssue(issueId) {
    ...
    if (!await this.ensureReady()) return null;
    return this._mapPmIssueRow(this._db.prepare('SELECT * FROM pm_issue_registry WHERE issue_id = ?').get(normalizedId));
  }
