...
python template/.kiro/tools/ultrawork_enhancer_v3.py requirements \
    .kiro/specs/my-feature/requirements.md

# Enhance design
python template/.kiro/tools/ultrawork_enhancer_v3.py design \
    .kiro/specs/my-feature/design.md \
    .kiro/specs/my-feature/requirements.md

# Validate tasks
python template/.kiro/tools/ultrawork_enhancer_v3.py tasks \
...
```bash
# Requirements gate
python template/.kiro/tools/workflow_quality_gate.py requirements \
    .kiro/specs/my-feature/requirements.md
...
# Tasks gate
python template/.kiro/tools/workflow_quality_gate.py tasks \
    .kiro/specs/my-feature/tasks.md
# Exit code: 0 (pass) or 1 (fail)
```
...
### Reference Documents
- `.kiro/specs/SPEC_WORKFLOW_GUIDE.md` - Spec workflow
- `.kiro/steering/CORE_PRINCIPLES.md` - Development principles
- `.kiro/steering/CURRENT_CONTEXT.md` - Current context
