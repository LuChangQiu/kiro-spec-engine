...
- **Implementation**: Template library in `.kiro/templates/operations/` + project overrides in `.kiro/specs/{project}/operations/`
...
```
.kiro/specs/{project-name}/operations/
