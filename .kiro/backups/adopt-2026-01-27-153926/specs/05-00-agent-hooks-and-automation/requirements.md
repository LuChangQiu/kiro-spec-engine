...
1. WHEN I run `kse hooks init`, THE System SHALL create `.kiro/hooks/` directory with default hook templates
...
4. THE System SHALL log all hook executions to `.kiro/hooks/execution.log`
...
1. THE System SHALL store automation config in `.kiro/automation-config.json`
