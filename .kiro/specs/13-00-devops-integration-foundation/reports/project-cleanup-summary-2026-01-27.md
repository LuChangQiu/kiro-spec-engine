...
**删除的目录**:
- `.kiro/specs/13-00-devops-integration-foundation/docs/` (非标准)
- `.kiro/specs/13-00-devops-integration-foundation/custom/` (空目录)
...
# 5. 清理非标准目录
rm -rf .kiro/specs/13-00-devops-integration-foundation/docs/
rm -rf .kiro/specs/13-00-devops-integration-foundation/custom/
