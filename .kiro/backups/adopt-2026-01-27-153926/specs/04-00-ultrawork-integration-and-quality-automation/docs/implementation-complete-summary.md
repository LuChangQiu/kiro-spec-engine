...
**File**: `template/.kiro/tools/document_evaluator.py` (400+ lines)
...
**File**: `template/.kiro/tools/improvement_identifier.py` (350+ lines)
...
**File**: `template/.kiro/tools/modification_applicator.py` (700+ lines)
...
### 4. Quality Scorer
**File**: `template/.kiro/tools/quality_scorer.py` (250+ lines)
...
**File**: `template/.kiro/tools/ultrawork_enhancer_v3.py` (600+ lines)
...
### 6. Backup Manager
**File**: `template/.kiro/tools/backup_manager.py` (280+ lines)
...
### 7. Error Handler
**File**: `template/.kiro/tools/error_handler.py` (335+ lines)
...
python template/.kiro/tools/ultrawork_enhancer_v3.py requirements path/to/requirements.md

# Enhance design document
python template/.kiro/tools/ultrawork_enhancer_v3.py design path/to/design.md path/to/requirements.md

# Validate tasks document
python template/.kiro/tools/ultrawork_enhancer_v3.py tasks path/to/tasks.md
```
