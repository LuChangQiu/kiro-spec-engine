...
Automatically detect and fix .gitignore files during kse adoption and upgrade to ensure team collaboration works correctly. The system replaces old blanket `.sce/` exclusion patterns with a layered strategy that commits Specs while excluding personal state.
