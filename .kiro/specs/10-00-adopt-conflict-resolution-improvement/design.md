...
│  - Creates targeted backups   │      │  - Full .kiro/ backups           │
...
**Purpose**: Creates targeted backups of only the files that will be overwritten, rather than backing up the entire .kiro/ directory.
...
**Backup Structure**:
```
.kiro/backups/conflict-2026-01-24-143022/
...
```javascript
{
  path: string,              // Relative path from .kiro/ (e.g., "steering/CORE_PRINCIPLES.md")
...
3. Backup and restore with real .kiro/ directory
