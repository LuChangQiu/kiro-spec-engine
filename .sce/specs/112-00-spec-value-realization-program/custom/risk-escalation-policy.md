...
```bash
node .sce/specs/112-00-spec-value-realization-program/custom/scripts/evaluate-risk.js \
  --dir .sce/specs/112-00-spec-value-realization-program/custom/weekly-metrics \
  --out .sce/specs/112-00-spec-value-realization-program/custom/weekly-metrics/risk-evaluation.latest.json
```
