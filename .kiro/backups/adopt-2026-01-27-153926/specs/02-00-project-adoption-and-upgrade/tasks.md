...
- [ ]* 3.2 Write property test for backup integrity
  ...
  - Generate random .kiro/ structures, backup, validate all files present
  - _Requirements: 5.1_

- [ ]* 3.3 Write property test for rollback restoration
  - **Property 12: Rollback Restoration**
  - **Validates: Requirements 4.3**
  - Generate random .kiro/ state, backup, modify, rollback, verify restoration
  - _Requirements: 4.3_

- [ ]* 3.4 Write unit tests for BackupSystem
  - Test backup creation with various .kiro/ structures
...
- [ ]* 4.3 Write property test for adoption mode selection
  ...
  - Generate projects with various .kiro/ states, verify correct mode selected
  - _Requirements: 1.2_
...
- [ ]* 4.5 Write unit tests for DetectionEngine
  ...
  - Test edge cases (empty .kiro/, partial structure)
...
- [ ] 16.2 Implement adoption and upgrade reports
  ...
  - Save reports to `.kiro/reports/` directory
  - _Requirements: 1.4, 3.2_
