...
async function runSceneDiscoverCommand(rawOptions = {}, dependencies = {}) {
  ...
  try {
    ...
    if (options.type) {
      ...
      const entitiesData = (entitiesRes && entitiesRes.body && entitiesRes.body.data) || [];
      const servicesData = (servicesRes && servicesRes.body && servicesRes.body.data) || [];
      const screensData = (screensRes && screensRes.body && screensRes.body.data) || [];
