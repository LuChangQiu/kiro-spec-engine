...
describe('init command integration', () => {
  it('should create project structure with all required files', () => {
    ...
    // Verify structure
    expect(fs.existsSync(path.join(testDir, 'test-project/.kiro'))).toBe(true);
    expect(fs.existsSync(path.join(testDir, 'test-project/.kiro/specs'))).toBe(true);
    expect(fs.existsSync(path.join(testDir, 'test-project/.kiro/steering'))).toBe(true);
