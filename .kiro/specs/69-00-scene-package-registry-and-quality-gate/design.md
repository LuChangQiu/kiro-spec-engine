...
### Inputs
- Template root directory (default: `.kiro/templates/scene-packages`)
...
```bash
kse scene package-registry   --template-dir .kiro/templates/scene-packages   --out .kiro/reports/scene-package-registry.json   --strict   --json
```
