...
const { pruneCloseLoopBatchSummarySessions: pruneCloseLoopBatchSummarySessionsService, pruneCloseLoopControllerSessions: pruneCloseLoopControllerSessionsService, pruneCloseLoopSessions: pruneCloseLoopSessionsService, pruneCloseLoopBatchSummarySessionsCli: pruneCloseLoopBatchSummarySessionsCliService, pruneCloseLoopControllerSessionsCli: pruneCloseLoopControllerSessionsCliService } = require('../auto/session-prune-service');
const { maybePersistCloseLoopControllerSummary: maybePersistCloseLoopControllerSummaryService, maybePersistCloseLoopBatchSummary: maybePersistCloseLoopBatchSummaryService } = require('../auto/session-persistence-service');
const { readGovernanceCloseLoopSessionEntries: readGovernanceCloseLoopSessionEntriesService, loadGovernanceCloseLoopSessionPayload: loadGovernanceCloseLoopSessionPayloadService, persistGovernanceCloseLoopSession: persistGovernanceCloseLoopSessionService } = require('../auto/governance-session-storage-service');
const { readCloseLoopControllerSessionEntries: readCloseLoopControllerSessionEntriesService, loadCloseLoopControllerSessionPayload: loadCloseLoopControllerSessionPayloadService } = require('../auto/controller-session-storage-service');
const { getCloseLoopBatchSummaryDir: getCloseLoopBatchSummaryDirService, readCloseLoopBatchSummaryEntries: readCloseLoopBatchSummaryEntriesService, resolveCloseLoopBatchSummaryFile: resolveCloseLoopBatchSummaryFileService, loadCloseLoopBatchSummaryPayload: loadCloseLoopBatchSummaryPayloadService } = require('../auto/batch-summary-storage-service');
const { getCloseLoopSessionDir: getCloseLoopSessionDirService, readCloseLoopSessionEntries: readCloseLoopSessionEntriesService } = require('../auto/close-loop-session-storage-service');
const { normalizeBatchFormat: normalizeBatchFormatService, parseGoalsFromJsonPayload: parseGoalsFromJsonPayloadService, parseGoalsFromLines: parseGoalsFromLinesService, loadCloseLoopBatchGoals: loadCloseLoopBatchGoalsService, buildCloseLoopBatchGoalsFromGoal: buildCloseLoopBatchGoalsFromGoalService, normalizeResumeStrategy: normalizeResumeStrategyService, buildCloseLoopBatchGoalsFromSummaryPayload: buildCloseLoopBatchGoalsFromSummaryPayloadService, loadCloseLoopBatchGoalsFromSummary: loadCloseLoopBatchGoalsFromSummaryService } = require('../auto/batch-goal-input-service');
const { checkAutoArchiveSchema: checkAutoArchiveSchemaService, migrateAutoArchiveSchema: migrateAutoArchiveSchemaService } = require('../auto/archive-schema-service');
const { executeCloseLoopRecoveryCycle: executeCloseLoopRecoveryCycleService } = require('../auto/close-loop-recovery-service');
const { executeCloseLoopBatch: executeCloseLoopBatchService } = require('../auto/close-loop-batch-service');
const { resolveControllerQueueFile: resolveControllerQueueFileService, resolveControllerQueueFormat: resolveControllerQueueFormatService, dedupeControllerGoals: dedupeControllerGoalsService, loadControllerGoalQueue: loadControllerGoalQueueService, writeControllerGoalQueue: writeControllerGoalQueueService, appendControllerGoalArchive: appendControllerGoalArchiveService } = require('../auto/controller-queue-service');
const { buildControllerLockPayload: buildControllerLockPayloadService, resolveControllerLockFile: resolveControllerLockFileService, readControllerLockPayload: readControllerLockPayloadService, writeControllerLockPayload: writeControllerLockPayloadService, isControllerLockStale: isControllerLockStaleService } = require('../auto/controller-lock-service');
const { printCloseLoopControllerSummary: printCloseLoopControllerSummaryService } = require('../auto/controller-output');
const { runCloseLoopController: runCloseLoopControllerService } = require('../auto/close-loop-controller-service');
const { buildAutoObservabilitySnapshot: buildAutoObservabilitySnapshotService } = require('../auto/observability-service');
const { executeCloseLoopProgramGoal: executeCloseLoopProgramGoalService } = require('../auto/close-loop-program-service');
...
const { resolveResultSourceIndex: resolveResultSourceIndexService, getBatchFailureStatusSet: getBatchFailureStatusSetService, buildProgramCoordinationSnapshot: buildProgramCoordinationSnapshotService, mergeProgramRecoveryIntoProgramSummary: mergeProgramRecoveryIntoProgramSummaryService, buildProgramKpiSnapshot: buildProgramKpiSnapshotService } = require('../auto/program-summary');
const { maybeWriteProgramKpi: maybeWriteProgramKpiService, maybeWriteProgramAudit: maybeWriteProgramAuditService } = require('../auto/program-output');
const { printCloseLoopBatchSummary: printCloseLoopBatchSummaryService } = require('../auto/batch-output');
const { normalizeProgramGateFallbackProfile: normalizeProgramGateFallbackProfileService, normalizeProgramGateFallbackChain: normalizeProgramGateFallbackChainService, resolveProgramGateFallbackChain: resolveProgramGateFallbackChainService, resolveProgramGatePolicy: resolveProgramGatePolicyService, evaluateProgramConvergenceGate: evaluateProgramConvergenceGateService, buildProgramAnomalyGovernancePatch: buildProgramAnomalyGovernancePatchService, normalizeFailureSignatureFromError: normalizeFailureSignatureFromErrorService } = require('../auto/program-governance-helpers');
const { hasRecoverableProgramGoals: hasRecoverableProgramGoalsService, applyProgramGovernancePatch: applyProgramGovernancePatchService, buildProgramGovernanceReplayGoalsResult: buildProgramGovernanceReplayGoalsResultService, runProgramGovernanceLoop: runProgramGovernanceLoopService } = require('../auto/program-governance-loop-service');
const { applyProgramGateAutoRemediation: applyProgramGateAutoRemediationService } = require('../auto/program-auto-remediation-service');
const { maybeWriteOutput: maybeWriteOutputService, maybeWriteTextOutput: maybeWriteTextOutputService } = require('../auto/output-writer');
const { buildAutoHandoffCapabilityMatrixPolicy: buildAutoHandoffCapabilityMatrixPolicyService, buildAutoHandoffCapabilityMatrixRecommendations: buildAutoHandoffCapabilityMatrixRecommendationsService, buildAutoHandoffCapabilityMatrix: buildAutoHandoffCapabilityMatrixService } = require('../auto/handoff-capability-matrix-service');
const { loadAutoHandoffReleaseEvidence: loadAutoHandoffReleaseEvidenceService, mergeAutoHandoffRunIntoReleaseEvidence: mergeAutoHandoffRunIntoReleaseEvidenceService, writeAutoHandoffRunReport: writeAutoHandoffRunReportService } = require('../auto/handoff-release-evidence-service');
const { buildAutoHandoffEvidenceSnapshot: buildAutoHandoffEvidenceSnapshotService, buildAutoHandoffEvidenceStatusCounts: buildAutoHandoffEvidenceStatusCountsService, resolveAutoHandoffReleaseDraftContext: resolveAutoHandoffReleaseDraftContextService, buildAutoHandoffEvidenceReviewReport: buildAutoHandoffEvidenceReviewReportService } = require('../auto/handoff-evidence-review-service');
const { buildAutoHandoffReleaseGateHistoryIndex: buildAutoHandoffReleaseGateHistoryIndexService, renderAutoHandoffReleaseGateHistoryMarkdown: renderAutoHandoffReleaseGateHistoryMarkdownService } = require('../auto/handoff-release-gate-history-service');
const { buildAutoHandoffReleaseGateHistoryEntry: buildAutoHandoffReleaseGateHistoryEntryService, loadAutoHandoffReleaseGateReports: loadAutoHandoffReleaseGateReportsService, loadAutoHandoffReleaseGateHistorySeed: loadAutoHandoffReleaseGateHistorySeedService, mergeAutoHandoffReleaseGateHistoryEntries: mergeAutoHandoffReleaseGateHistoryEntriesService } = require('../auto/handoff-release-gate-history-loaders-service');
const { buildAutoHandoffMoquiBaselineSnapshot: buildAutoHandoffMoquiBaselineSnapshotService, buildAutoHandoffScenePackageBatchSnapshot: buildAutoHandoffScenePackageBatchSnapshotService, buildAutoHandoffCapabilityCoverageSnapshot: buildAutoHandoffCapabilityCoverageSnapshotService } = require('../auto/handoff-snapshots-service');
const { runAutoHandoff: runAutoHandoffService } = require('../auto/handoff-run-service');
const { buildAutoHandoffRegressionSnapshot: buildAutoHandoffRegressionSnapshotService, buildAutoHandoffRegressionComparison: buildAutoHandoffRegressionComparisonService, buildAutoHandoffRegressionWindowTrend: buildAutoHandoffRegressionWindowTrendService, buildAutoHandoffRegressionAggregates: buildAutoHandoffRegressionAggregatesService, buildAutoHandoffRegressionRiskLayers: buildAutoHandoffRegressionRiskLayersService, buildAutoHandoffRegressionRecommendations: buildAutoHandoffRegressionRecommendationsService, formatAutoHandoffRegressionValue: formatAutoHandoffRegressionValueService, getAutoHandoffMoquiCoverageMatrix: getAutoHandoffMoquiCoverageMatrixService, getAutoHandoffMoquiCoverageMetric: getAutoHandoffMoquiCoverageMetricService, formatAutoHandoffMoquiCoverageMetric: formatAutoHandoffMoquiCoverageMetricService, getAutoHandoffMoquiCoverageDeltaMatrix: getAutoHandoffMoquiCoverageDeltaMatrixService, getAutoHandoffMoquiCoverageDeltaMetric: getAutoHandoffMoquiCoverageDeltaMetricService, formatAutoHandoffMoquiCoverageDeltaMetric: formatAutoHandoffMoquiCoverageDeltaMetricService, getAutoHandoffMoquiCoverageMetricLabel: getAutoHandoffMoquiCoverageMetricLabelService, buildAutoHandoffMoquiCoverageRegressions: buildAutoHandoffMoquiCoverageRegressionsService, formatAutoHandoffMoquiCoverageRegressions: formatAutoHandoffMoquiCoverageRegressionsService, renderAutoHandoffRegressionMarkdown: renderAutoHandoffRegressionMarkdownService, renderAutoHandoffEvidenceReviewMarkdown: renderAutoHandoffEvidenceReviewMarkdownService, renderAutoHandoffReleaseNotesDraft: renderAutoHandoffReleaseNotesDraftService, buildAutoHandoffRegression: buildAutoHandoffRegressionService, buildAutoHandoffRegressionReport: buildAutoHandoffRegressionReportService } = require('../auto/handoff-reporting-service');
const { getCloseLoopRecoveryMemoryFile: getCloseLoopRecoveryMemoryFileService, loadCloseLoopRecoveryMemory: loadCloseLoopRecoveryMemoryService, normalizeRecoveryMemoryToken: normalizeRecoveryMemoryTokenService, resolveRecoveryMemoryScope: resolveRecoveryMemoryScopeService, resolveGitBranchToken: resolveGitBranchTokenService, buildRecoveryMemorySignature: buildRecoveryMemorySignatureService, getRecoveryActionMemoryKey: getRecoveryActionMemoryKeyService, selectRecoveryActionFromMemory: selectRecoveryActionFromMemoryService, getRecoveryMemoryEntry: getRecoveryMemoryEntryService, updateCloseLoopRecoveryMemory: updateCloseLoopRecoveryMemoryService, summarizeRecoveryMemory: summarizeRecoveryMemoryService, filterRecoveryMemoryByScope: filterRecoveryMemoryByScopeService, buildRecoveryMemoryScopeStats: buildRecoveryMemoryScopeStatsService, showCloseLoopRecoveryMemory: showCloseLoopRecoveryMemoryService, showCloseLoopRecoveryMemoryScopes: showCloseLoopRecoveryMemoryScopesService, pruneCloseLoopRecoveryMemory: pruneCloseLoopRecoveryMemoryService, clearCloseLoopRecoveryMemory: clearCloseLoopRecoveryMemoryService, resolveRecoveryActionSelection: resolveRecoveryActionSelectionService, applyRecoveryActionPatch: applyRecoveryActionPatchService } = require('../auto/recovery-memory-service');
...
function normalizeBatchFormat(formatCandidate) {
  return normalizeBatchFormatService(formatCandidate);
}

function parseGoalsFromJsonPayload(payload) {
  return parseGoalsFromJsonPayloadService(payload);
}

function parseGoalsFromLines(content) {
  return parseGoalsFromLinesService(content);
}

async function loadCloseLoopBatchGoals(projectPath, goalsFile, formatCandidate) {
  return loadCloseLoopBatchGoalsService(projectPath, goalsFile, formatCandidate, {
    fs,
    path
  });
}
...
function buildCloseLoopBatchGoalsFromGoal(goalCandidate, programGoalsCandidate, settings = {}) {
  return buildCloseLoopBatchGoalsFromGoalService(goalCandidate, programGoalsCandidate, settings, {
    analyzeGoalSemantics
  });
}

function normalizeResumeStrategy(resumeStrategyCandidate) {
  return normalizeResumeStrategyService(resumeStrategyCandidate);
}

function getCloseLoopBatchSummaryDir(projectPath) {
  return getCloseLoopBatchSummaryDirService(projectPath);
}

async function resolveCloseLoopBatchSummaryFile(projectPath, summaryCandidate) {
  return resolveCloseLoopBatchSummaryFileService(projectPath, summaryCandidate, { fs });
}

async function loadCloseLoopBatchSummaryPayload(projectPath, summaryCandidate) {
  return loadCloseLoopBatchSummaryPayloadService(projectPath, summaryCandidate, { fs });
}
...
function getCloseLoopRecoveryMemoryFile(projectPath) {
  return getCloseLoopRecoveryMemoryFileService(projectPath, { path });
}

async function loadCloseLoopRecoveryMemory(projectPath) {
  return loadCloseLoopRecoveryMemoryService(projectPath, {
    fs,
...
function normalizeRecoveryMemoryToken(value) {
  return normalizeRecoveryMemoryTokenService(value);
}

async function resolveRecoveryMemoryScope(projectPath, scopeCandidate) {
  return resolveRecoveryMemoryScopeService(projectPath, scopeCandidate, {
    path,
...
async function resolveGitBranchToken(projectPath) {
  return resolveGitBranchTokenService(projectPath, {
    path,
    fs,
    normalizeRecoveryMemoryToken
  });
...
function buildRecoveryMemorySignature(summaryPayload, context = {}) {
  return buildRecoveryMemorySignatureService(summaryPayload, context, {
...
function getRecoveryActionMemoryKey(action, index) {
  return getRecoveryActionMemoryKeyService(action, index, {
    normalizeRecoveryMemoryToken
  });
}

function selectRecoveryActionFromMemory(availableActions, recoveryMemoryEntry) {
  return selectRecoveryActionFromMemoryService(availableActions, recoveryMemoryEntry, {
    getRecoveryActionMemoryKey
  });
}

function getRecoveryMemoryEntry(recoveryMemoryPayload, signature) {
  return getRecoveryMemoryEntryService(recoveryMemoryPayload, signature);
}
...
async function updateCloseLoopRecoveryMemory(
  ...
  return updateCloseLoopRecoveryMemoryService(
    projectPath,
    recoveryMemory,
    signature,
    selectedIndex,
...
function summarizeRecoveryMemory(memoryPayload) {
  return summarizeRecoveryMemoryService(memoryPayload, {
    normalizeRecoveryMemoryToken
  });
}

function filterRecoveryMemoryByScope(memoryPayload, scopeCandidate) {
  return filterRecoveryMemoryByScopeService(memoryPayload, scopeCandidate, {
    normalizeRecoveryMemoryToken
  });
}

function buildRecoveryMemoryScopeStats(memoryPayload) {
  return buildRecoveryMemoryScopeStatsService(memoryPayload, {
    normalizeRecoveryMemoryToken
  });
}

async function showCloseLoopRecoveryMemory(projectPath, options = {}) {
  return showCloseLoopRecoveryMemoryService(projectPath, options, {
...
async function showCloseLoopRecoveryMemoryScopes(projectPath) {
  return showCloseLoopRecoveryMemoryScopesService(projectPath, {
    loadCloseLoopRecoveryMemory,
...
async function pruneCloseLoopRecoveryMemory(projectPath, options = {}) {
  return pruneCloseLoopRecoveryMemoryService(projectPath, options, {
    fs,
    path,
    Date,
...
async function clearCloseLoopRecoveryMemory(projectPath) {
  return clearCloseLoopRecoveryMemoryService(projectPath, {
    fs,
    getCloseLoopRecoveryMemoryFile
  });
}
...
function resolveRecoveryActionSelection(summaryPayload, actionCandidate, context = {}) {
  return resolveRecoveryActionSelectionService(summaryPayload, actionCandidate, context, {
    buildProgramDiagnostics,
...
function applyRecoveryActionPatch(options, selectedAction) {
  return applyRecoveryActionPatchService(options, selectedAction);
}
...
async function buildCloseLoopBatchGoalsFromSummaryPayload(
  ...
  return buildCloseLoopBatchGoalsFromSummaryPayloadService(
    summary,
    summaryFile,
    projectPath,
    formatCandidate,
...
async function loadCloseLoopBatchGoalsFromSummary(
  ...
  return loadCloseLoopBatchGoalsFromSummaryService(
    projectPath,
    summaryCandidate,
    formatCandidate,
    resumeStrategyCandidate,
...
function normalizeProgramGateFallbackProfile(profileCandidate) {
  return normalizeProgramGateFallbackProfileService(profileCandidate, {
    PROGRAM_GATE_PROFILE_POLICY
  });
}

function normalizeProgramGateFallbackChain(chainCandidate) {
  return normalizeProgramGateFallbackChainService(chainCandidate, {
    PROGRAM_GATE_PROFILE_POLICY
  });
}

function resolveProgramGateFallbackChain(chainCandidate, fallbackProfileCandidate) {
  return resolveProgramGateFallbackChainService(chainCandidate, fallbackProfileCandidate, {
    PROGRAM_GATE_PROFILE_POLICY
  });
}
...
function resolveProgramGatePolicy(policy = {}) {
  return resolveProgramGatePolicyService(policy, {
    PROGRAM_GATE_PROFILE_POLICY,
    normalizeProgramGateProfile,
    normalizeProgramMinSuccessRate,
    normalizeProgramRiskLevel,
    normalizeProgramMaxElapsedMinutes,
    normalizeProgramMaxAgentBudget,
    normalizeProgramMaxTotalSubSpecs
  });
}
...
async function executeCloseLoopBatch(goalsResult, options, projectPath, mode = 'auto-close-loop-batch') {
  return executeCloseLoopBatchService(goalsResult, options, projectPath, mode, {
    buildGoalInputGuard,
...
async function executeCloseLoopProgramGoal(goal, options = {}, context = {}) {
  return executeCloseLoopProgramGoalService(goal, options, context, {
...
function resolveResultSourceIndex(item, fallbackIndex = 0) {
  return resolveResultSourceIndexService(item, fallbackIndex);
}

function getBatchFailureStatusSet() {
  return getBatchFailureStatusSetService();
}

function buildProgramCoordinationSnapshot(summary) {
  return buildProgramCoordinationSnapshotService(summary);
}

function mergeProgramRecoveryIntoProgramSummary(initialSummary, recoverySummary, metadata = {}) {
  return mergeProgramRecoveryIntoProgramSummaryService(initialSummary, recoverySummary, metadata, {
    buildBatchMetrics,
    mergeBatchResourcePlans
  });
}

async function executeCloseLoopRecoveryCycle(input) {
  return executeCloseLoopRecoveryCycleService(input, {
...
function resolveControllerQueueFormat(resolvedQueueFile, formatCandidate) {
  return resolveControllerQueueFormatService(normalizeBatchFormat, resolvedQueueFile, formatCandidate);
}

function dedupeControllerGoals(goals) {
  return dedupeControllerGoalsService(goals);
}

async function loadControllerGoalQueue(projectPath, queueFileCandidate, formatCandidate, options = {}) {
  return loadControllerGoalQueueService(
    path,
    fs,
...
async function writeControllerGoalQueue(file, format, goals) {
  return writeControllerGoalQueueService(path, fs, file, format, goals);
}

async function appendControllerGoalArchive(fileCandidate, projectPath, goal, metadata = {}) {
  return appendControllerGoalArchiveService(path, fs, fileCandidate, projectPath, goal, metadata);
}
...
function resolveControllerLockFile(projectPath, queueFilePath, lockFileCandidate) {
  return resolveControllerLockFileService(path, projectPath, queueFilePath, lockFileCandidate);
}

async function readControllerLockPayload(lockFile) {
  return readControllerLockPayloadService(fs, lockFile);
}

function buildControllerLockPayload(lockToken) {
  return buildControllerLockPayloadService(lockToken);
}

async function writeControllerLockPayload(lockFile, payload, mode = 'overwrite') {
  return writeControllerLockPayloadService(path, fs, lockFile, payload, mode);
}

function isControllerLockStale(stats, ttlSeconds) {
  return isControllerLockStaleService(stats, ttlSeconds, Date.now());
}
...
async function runCloseLoopController(queueFile, options = {}, context = {}) {
  return runCloseLoopControllerService(queueFile, options, context, {
...
function printCloseLoopControllerSummary(summary) {
  return printCloseLoopControllerSummaryService(chalk, summary);
}

function printCloseLoopBatchSummary(summary, options) {
  return printCloseLoopBatchSummaryService(chalk, summary, options);
}

async function maybeWriteOutput(result, outCandidate, projectPath) {
  return maybeWriteOutputService(result, outCandidate, projectPath, {
    pathModule: path,
    fs
  });
}
...
async function maybeWriteTextOutput(result, content, outCandidate, projectPath) {
  return maybeWriteTextOutputService(result, content, outCandidate, projectPath, {
    pathModule: path,
    fs
  });
}
...
function buildAutoHandoffRegressionSnapshot(report) {
  return buildAutoHandoffRegressionSnapshotService(report, {
...
function buildAutoHandoffRegressionComparison(currentSnapshot, previousSnapshot) {
  return buildAutoHandoffRegressionComparisonService(currentSnapshot, previousSnapshot);
}

function buildAutoHandoffRegressionWindowTrend(series = []) {
  return buildAutoHandoffRegressionWindowTrendService(series);
}

function buildAutoHandoffRegressionAggregates(series = []) {
  return buildAutoHandoffRegressionAggregatesService(series);
}

function buildAutoHandoffRegressionRiskLayers(series = []) {
  return buildAutoHandoffRegressionRiskLayersService(series);
}

function buildAutoHandoffRegressionRecommendations(payload = {}) {
  return buildAutoHandoffRegressionRecommendationsService(payload);
}

function formatAutoHandoffRegressionValue(value, fallback = 'n/a') {
  return formatAutoHandoffRegressionValueService(value, fallback);
}

function getAutoHandoffMoquiCoverageMatrix(summary = {}) {
  return getAutoHandoffMoquiCoverageMatrixService(summary);
}

function getAutoHandoffMoquiCoverageMetric(summary = {}, metricName = '', field = 'rate_percent') {
  return getAutoHandoffMoquiCoverageMetricService(summary, metricName, field);
}

function formatAutoHandoffMoquiCoverageMetric(summary = {}, metricName = '', field = 'rate_percent', suffix = '') {
  return formatAutoHandoffMoquiCoverageMetricService(summary, metricName, field, suffix);
}

function getAutoHandoffMoquiCoverageDeltaMatrix(compare = {}) {
  return getAutoHandoffMoquiCoverageDeltaMatrixService(compare);
}

function getAutoHandoffMoquiCoverageDeltaMetric(compare = {}, metricName = '', field = 'rate_percent') {
  return getAutoHandoffMoquiCoverageDeltaMetricService(compare, metricName, field);
}

function formatAutoHandoffMoquiCoverageDeltaMetric(compare = {}, metricName = '', field = 'rate_percent', suffix = '') {
  return formatAutoHandoffMoquiCoverageDeltaMetricService(compare, metricName, field, suffix);
}

function getAutoHandoffMoquiCoverageMetricLabel(metricName = '') {
  return getAutoHandoffMoquiCoverageMetricLabelService(metricName);
}

function buildAutoHandoffMoquiCoverageRegressions(compare = {}) {
  return buildAutoHandoffMoquiCoverageRegressionsService(compare, {
    normalizeHandoffText
  });
}

function formatAutoHandoffMoquiCoverageRegressions(compare = {}, limit = 3) {
  return formatAutoHandoffMoquiCoverageRegressionsService(compare, limit);
}

function renderAutoHandoffRegressionMarkdown(payload = {}) {
  return renderAutoHandoffRegressionMarkdownService(payload);
}
...
function buildAutoHandoffReleaseGateHistoryEntry(entry = {}, options = {}) {
  return buildAutoHandoffReleaseGateHistoryEntryService(entry, options, {
    parseAutoHandoffGateSignalsMap,
    normalizeHandoffText,
    parseAutoHandoffReleaseGateTag,
...
async function loadAutoHandoffReleaseGateReports(projectPath, dirCandidate = null) {
  return loadAutoHandoffReleaseGateReportsService(projectPath, dirCandidate, {
    resolveAutoHandoffReleaseEvidenceDir,
    fs,
    parseAutoHandoffReleaseGateTag,
...
async function loadAutoHandoffReleaseGateHistorySeed(projectPath, fileCandidate = null) {
  return loadAutoHandoffReleaseGateHistorySeedService(projectPath, fileCandidate, {
...
function mergeAutoHandoffReleaseGateHistoryEntries(entries = []) {
  return mergeAutoHandoffReleaseGateHistoryEntriesService(entries, {
    normalizeHandoffText,
...
async function buildAutoHandoffReleaseGateHistoryIndex(projectPath, options = {}) {
  return buildAutoHandoffReleaseGateHistoryIndexService(projectPath, options, {
...
function renderAutoHandoffReleaseGateHistoryMarkdown(payload = {}) {
  return renderAutoHandoffReleaseGateHistoryMarkdownService(payload, {
    formatAutoHandoffRegressionValue
  });
}

async function loadAutoHandoffReleaseEvidence(projectPath, fileCandidate = null) {
  return loadAutoHandoffReleaseEvidenceService(projectPath, fileCandidate, {
...
function buildAutoHandoffEvidenceSnapshot(entry = {}) {
  return buildAutoHandoffEvidenceSnapshotService(entry, {
    normalizeHandoffText,
...
function buildAutoHandoffEvidenceStatusCounts(entries = []) {
  return buildAutoHandoffEvidenceStatusCountsService(entries);
}

function renderAutoHandoffEvidenceReviewMarkdown(payload = {}) {
  return renderAutoHandoffEvidenceReviewMarkdownService(payload);
}
...
async function resolveAutoHandoffReleaseDraftContext(projectPath, options = {}) {
  return resolveAutoHandoffReleaseDraftContextService(projectPath, options, {
    fs,
    pathModule: path,
    normalizeHandoffReleaseVersion,
    normalizeHandoffReleaseDate
  });
}

function renderAutoHandoffReleaseNotesDraft(payload = {}, context = {}) {
  return renderAutoHandoffReleaseNotesDraftService(payload, context, {
    normalizeHandoffReleaseVersion,
    normalizeHandoffReleaseDate
  });
}
...
async function buildAutoHandoffEvidenceReviewReport(projectPath, options = {}) {
  return buildAutoHandoffEvidenceReviewReportService(projectPath, options, {
...
async function buildAutoHandoffRegression(projectPath, currentResult) {
  return buildAutoHandoffRegressionService(projectPath, currentResult, {
...
async function buildAutoHandoffRegressionReport(projectPath, options = {}) {
  return buildAutoHandoffRegressionReportService(projectPath, options, {
    listAutoHandoffRunReports,
    normalizeHandoffSessionQuery,
...
function buildAutoHandoffCapabilityMatrixPolicy(options = {}) {
  return buildAutoHandoffCapabilityMatrixPolicyService(options, {
...
async function mergeAutoHandoffRunIntoReleaseEvidence(projectPath, result, reportFile = null) {
  return mergeAutoHandoffRunIntoReleaseEvidenceService(projectPath, result, reportFile, {
    resolveAutoHandoffReleaseEvidenceFile,
...
async function writeAutoHandoffRunReport(projectPath, result, outCandidate = null) {
  return writeAutoHandoffRunReportService(projectPath, result, outCandidate, {
    maybeWriteOutput,
    reportDir: AUTO_HANDOFF_RUN_REPORT_DIR
  });
}
...
async function buildAutoHandoffMoquiBaselineSnapshot(projectPath) {
  return buildAutoHandoffMoquiBaselineSnapshotService(projectPath, {
    fs,
    path,
    spawnSync,
    toAutoHandoffCliPath,
    buildAutoHandoffMoquiCoverageRegressions,
    AUTO_HANDOFF_MOQUI_BASELINE_JSON_FILE,
    AUTO_HANDOFF_MOQUI_BASELINE_MARKDOWN_FILE
  });
}
...
async function buildAutoHandoffScenePackageBatchSnapshot(projectPath, manifestPath) {
  return buildAutoHandoffScenePackageBatchSnapshotService(projectPath, manifestPath, {
    fs,
    path,
    spawnSync,
    normalizeHandoffText,
    toAutoHandoffCliPath,
    parseAutoHandoffJsonFromCommandStdout,
    AUTO_HANDOFF_CLI_SCRIPT_FILE,
    AUTO_HANDOFF_SCENE_PACKAGE_BATCH_JSON_FILE,
    AUTO_HANDOFF_SCENE_PACKAGE_BATCH_TASK_QUEUE_FILE
  });
}
...
async function buildAutoHandoffCapabilityCoverageSnapshot(projectPath, handoff = null, policy = {}) {
  return buildAutoHandoffCapabilityCoverageSnapshotService(projectPath, handoff, policy, {
    fs,
    path,
    normalizeHandoffText,
    toAutoHandoffCliPath,
    resolveMoquiCapabilityDescriptor,
    MOQUI_CAPABILITY_LEXICON_INDEX,
    moquiCapabilityMatch,
    loadLatestMoquiCapabilityCoverageReport,
    buildCapabilityCoverageComparison,
    AUTO_HANDOFF_MOQUI_CAPABILITY_COVERAGE_JSON_FILE,
    AUTO_HANDOFF_MOQUI_CAPABILITY_COVERAGE_MARKDOWN_FILE,
    renderMoquiCapabilityCoverageMarkdown
  });
}

function buildAutoHandoffCapabilityMatrixRecommendations(result = {}) {
  return buildAutoHandoffCapabilityMatrixRecommendationsService(result, {
    normalizeHandoffText,
    quoteCliArg,
    buildAutoHandoffMoquiCoverageRegressions,
    buildMoquiRegressionRecoverySequenceLines,
    clusterRemediationFile: AUTO_HANDOFF_MOQUI_CLUSTER_REMEDIATION_FILE,
    baselineJsonFile: AUTO_HANDOFF_MOQUI_BASELINE_JSON_FILE
  });
}
...
async function buildAutoHandoffCapabilityMatrix(projectPath, options = {}) {
  return buildAutoHandoffCapabilityMatrixService(projectPath, options, {
...
async function runAutoHandoff(projectPath, options = {}) {
  return runAutoHandoffService(projectPath, options, {
    path,
    AUTO_HANDOFF_RELEASE_EVIDENCE_FILE,
...
function buildProgramKpiSnapshot(summary) {
  return buildProgramKpiSnapshotService(summary, {
    now: () => new Date().toISOString()
  });
}

function evaluateProgramConvergenceGate(summary, policy = {}) {
  return evaluateProgramConvergenceGateService(summary, policy, {
    buildProgramKpiSnapshot,
    resolveProgramGatePolicy
  });
}
...
function hasRecoverableProgramGoals(summary) {
  return hasRecoverableProgramGoalsService(summary, {
    getBatchFailureStatusSet
  });
}

function buildProgramAnomalyGovernancePatch(summary, anomalies, options = {}) {
  return buildProgramAnomalyGovernancePatchService(summary, anomalies, options, {
    normalizeBatchRetryRounds,
    normalizeBatchParallel,
...
function applyProgramGovernancePatch(baseOptions, patch) {
  return applyProgramGovernancePatchService(baseOptions, patch);
}

function buildProgramGovernanceReplayGoalsResult(baseGoalsResult, round, summary) {
  return buildProgramGovernanceReplayGoalsResultService(baseGoalsResult, round, summary);
}

async function runProgramGovernanceLoop(context = {}) {
  return runProgramGovernanceLoopService(context, {
    normalizeProgramGovernMaxRounds,
    normalizeProgramGovernMaxMinutes,
    normalizeProgramGovernAnomalyWeeks,
    normalizeAutoKpiTrendPeriod,
...
async function applyProgramGateAutoRemediation(summary, context = {}) {
  return applyProgramGateAutoRemediationService(summary, context, {
    collectSpecNamesFromBatchSummary,
    pruneSpecSessions,
...
function normalizeFailureSignatureFromError(errorMessage) {
  return normalizeFailureSignatureFromErrorService(errorMessage);
}

async function maybeWriteProgramKpi(summary, outCandidate, projectPath) {
  return maybeWriteProgramKpiService(summary, outCandidate, projectPath, {
    pathModule: path,
    fs
  });
}
...
async function maybeWriteProgramAudit(summary, outCandidate, projectPath) {
  return maybeWriteProgramAuditService(summary, outCandidate, projectPath, {
    pathModule: path,
    fs,
    now: () => new Date().toISOString()
  });
...
async function maybePersistCloseLoopControllerSummary(summary, options, projectPath) {
  return maybePersistCloseLoopControllerSummaryService(summary, options, projectPath, {
...
async function readCloseLoopBatchSummaryEntries(projectPath) {
  return readCloseLoopBatchSummaryEntriesService(projectPath, {
    fs
  });
}
...
async function pruneCloseLoopBatchSummarySessions(projectPath, policy = {}) {
  return pruneCloseLoopBatchSummarySessionsService(projectPath, policy, {
...
async function maybePersistCloseLoopBatchSummary(summary, options, projectPath) {
  return maybePersistCloseLoopBatchSummaryService(summary, options, projectPath, {
    normalizeBatchSessionKeep,
    normalizeBatchSessionOlderThanDays,
    sanitizeBatchSessionId,
...
function getCloseLoopSessionDir(projectPath) {
  return getCloseLoopSessionDirService(projectPath);
}
...
async function readCloseLoopSessionEntries(projectPath) {
  return readCloseLoopSessionEntriesService(projectPath, {
    fs
  });
}
...
async function buildAutoObservabilitySnapshot(projectPath, options = {}) {
  return buildAutoObservabilitySnapshotService(projectPath, options, {
    normalizeStatsWindowDays,
    normalizeStatusFilter,
    statsCloseLoopSessions,
    statsCloseLoopBatchSummarySessions,
...
function normalizeSchemaScope(scopeCandidate) {
  return require('../auto/archive-schema-service').normalizeSchemaScope(scopeCandidate);
}

function normalizeTargetSchemaVersion(targetVersionCandidate) {
  return require('../auto/archive-schema-service').normalizeTargetSchemaVersion(targetVersionCandidate);
}

function getAutoArchiveSchemaTargets(projectPath, scope) {
  return require('../auto/archive-schema-service').getAutoArchiveSchemaTargets(projectPath, scope, {
    getCloseLoopSessionDir,
    getCloseLoopBatchSummaryDir,
    getCloseLoopControllerSessionDir,
    getGovernanceCloseLoopSessionDir
...
function classifyArchiveSchemaCompatibility(schemaVersion) {
  return require('../auto/archive-schema-service').classifyArchiveSchemaCompatibility(
    schemaVersion,
    AUTO_ARCHIVE_SCHEMA_SUPPORTED_VERSIONS
  );
}

async function checkAutoArchiveSchema(projectPath, options = {}) {
  return checkAutoArchiveSchemaService(projectPath, options, {
    fs,
    calculatePercent,
    getCloseLoopSessionDir,
    getCloseLoopBatchSummaryDir,
    getCloseLoopControllerSessionDir,
    getGovernanceCloseLoopSessionDir,
    supportedVersions: AUTO_ARCHIVE_SCHEMA_SUPPORTED_VERSIONS
  });
}

async function migrateAutoArchiveSchema(projectPath, options = {}) {
  return migrateAutoArchiveSchemaService(projectPath, options, {
    fs,
    getCloseLoopSessionDir,
    getCloseLoopBatchSummaryDir,
    getCloseLoopControllerSessionDir,
    getGovernanceCloseLoopSessionDir,
    defaultVersion: AUTO_ARCHIVE_SCHEMA_VERSION
  });
}
...
async function pruneCloseLoopBatchSummarySessionsCli(projectPath, options = {}) {
  return pruneCloseLoopBatchSummarySessionsCliService(projectPath, options, {
    normalizeKeep,
    normalizeOlderThanDays,
    pruneCloseLoopBatchSummarySessions
  });
...
async function pruneCloseLoopControllerSessionsCli(projectPath, options = {}) {
  return pruneCloseLoopControllerSessionsCliService(projectPath, options, {
    normalizeKeep,
    normalizeOlderThanDays,
    pruneCloseLoopControllerSessions
  });
...
async function pruneCloseLoopSessions(projectPath, options = {}) {
  return pruneCloseLoopSessionsService(projectPath, options, {
    normalizeKeep,
    normalizeOlderThanDays,
    readCloseLoopSessionEntries,
    getCloseLoopSessionDir,
